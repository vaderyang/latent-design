 ...
 */
export const motion = {
  surface: { keyframes: "surface", dur: "3.2s", easing: "ease-in-out", means: "new understanding rises from the depths, blur to clarity (appearing = surfacing)" },
  settle: { keyframes: "settle", dur: "3s", easing: "ease-in-out", means: "a hypothesis accrues evidence and is promoted to a conclusion: tracking tightens, cyan turns gold" },
  sink: { keyframes: "sink", dur: "3.2s", easing: "ease-in-out", means: "a refuted hypothesis sinks, desaturates, folds away — but is never deleted (auditable)" },
  pulse: { keyframes: "pulse", dur: "2.6s", easing: "ease-in-out", means: "a change-of-mind / aha inflection flashes a brief blue cue (noteworthy, not an error) — the most faithful part of latent" },
